...
export default function FinalMonolith() {
  ...
  return (
    ...
    >
      ...
      {/* 4. Grid Details */}
      <VerticalParallax speed={1.2} className="absolute top-24 left-8 md:top-10 md:left-10 z-10">
      ...
      <VerticalParallax speed={1.2} className="absolute top-36 left-8 md:top-10 md:right-10 md:left-auto z-10">
      ...
      <div className="flex flex-col items-center justify-center z-10 w-full max-w-screen-2xl px-8 mt-56 md:mt-20">
        ...
        <VerticalParallax speed={1.6} className="mt-8 text-center max-w-3xl">
